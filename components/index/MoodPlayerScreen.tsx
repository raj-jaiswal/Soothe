...
export default function MoodPlayerScreen({
  moodId,
  moodLabel,
  onBack,
}: MoodPlayerScreenProps) {
  ...
  const cover = MOOD_COVER[key] ?? {
    uri: "https://picsum.photos/seed/default/400/400",
  };
          ...
          try {
            ...
            if (isMounted) {
              setSongs((prevSongs) => {
                ...
                if (prevSongs.some((s) => s.id === data.metadata.song_ID))
                  return prevSongs;
